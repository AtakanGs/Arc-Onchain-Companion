    ...
    <main className="shell">
      ...
      {step === "reveal" && result && <section className="onboarding revealSection">
        <div className="quizPanel revealCopy"><p className="eyebrow">GENESIS SIGNAL FOUND</p><h2>Meet your {result.family}.</h2><p className="lede">Your answers point to a <strong>{result.archetype}</strong> nature. Your wallet deterministically selected the {result.family} family.</p>
          ...
          {result.family === "Vexa" ? <div className="evolutionTease"><span>EVOLUTION POTENTIAL</span><strong>Veyra · Vexus</strong><p>Your future choices will decide which path awakens.</p></div> : <div className="evolutionTease"><span>VISUAL IDENTITY</span><strong>{result.family} is still concealed</strong><p>This family&apos;s production artwork will be revealed in a later build.</p></div>}
