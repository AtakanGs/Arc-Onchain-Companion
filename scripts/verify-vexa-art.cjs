...
const vexaEncoded = [
  ...
  readRaw(vexaSourceRoot, "part-01b0.b64"),
  readRaw(vexaSourceRoot, "part-01b1.b64"),
  readRaw(vexaSourceRoot, "part-01b2.b64"),
  readRaw(vexaSourceRoot, "part-01b3a.b64"),
  readRaw(vexaSourceRoot, "part-01b3b.b64"),
  readRaw(vexaSourceRoot, "part-01b3c0.b64"),
  readRaw(vexaSourceRoot, "part-01b3c1.b64"),
  readRaw(vexaSourceRoot, "part-01b3c2.b64"),
  readRaw(vexaSourceRoot, "part-01b3c3.b64"),
  readRaw(vexaSourceRoot, "part-01b3c4.b64"),
  readRaw(vexaSourceRoot, "part-01b3d.b64"),
  readRaw(vexaSourceRoot, "part-01c.b64"),
  readRaw(vexaSourceRoot, "part-01d.b64"),
  ...Array.from({ length: 9 }, (_, offset) => readWrapped(vexaSourceRoot, `part-${String(offset + 2).padStart(2, "0")}.txt`)),
].join("");

const nomaEncoded = Array.from({ length: 8 }, (_, index) =>
  readRaw(nomaSourceRoot, `part-${String(index).padStart(2, "0")}.b64`),
).join("");
