...
const locked = [
  ...
  { file: "noryth.webp", bytes: 12028, sha256: "cc4cf01cace59564a2972f7cb4aa62ab58fe118074c10af978f6961d2881fd8d" },
];
...
for (const asset of locked) {
  ...
  if (digest !== asset.sha256) throw new Error(`${asset.file}: locked art hash changed`);
